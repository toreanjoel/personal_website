...
const HTML_TEMPLATE = {
  ABOUT: `<div class="about-image-wrapper"><img src="./images/torean.jpg"></div><br/><span>Name:</span> Torean Joel - <a href="${LINKEDIN_LINK}" target="_blank">${LINKEDIN}</a><br/><span>Profession: Software Engineer - <a href="${TRIXTA_LINK}" target="_blank">${TRIXTA}</a><br/><br/><u>Who am I:</u><br/><br/>I\'m ${DEVELOPER}, a Software Developer. Initially a Front-End developer that quickly transistioned my career into a Fullstack development path.<br/><br/>I worked on numerous projects personal and commercial and comfortably find myself working in the cryptocurrency world.<br/><br/>Constantly learning and upskilling myself to help make a career one I can not only look back on feeling proud, but seeing an open-source world using the tools we arebuilding to help see organisations in a decentralised space finding success in an open-source world for everyone to better and collaborate on.<br/><br/>I also spend free time, hanging out with friends (Online friends are also friends). Gaming. Brazillian Jiu Jitsu. Solving personal technical problems and trying to get sunshinewhile looking for a reason to drink less coffee (I\'m probably drinking coffee while you\'re reading this).<br/><br/><u>What I do:</u><br/><br/>Working in the blockchain space building tools to help users transition to a decentralized world using visual programming tools.`,
